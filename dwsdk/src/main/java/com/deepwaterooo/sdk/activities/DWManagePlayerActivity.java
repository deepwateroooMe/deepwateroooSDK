...
import com.deepwaterooo.sdk.activities.players.DWAddEditPlayerActivity;
 ...
 */
public class DWManagePlayerActivity extends DWBaseActivity implements OnClickListener, ApiCallListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayersAdapter = new PlayersAdapter(DWManagePlayerActivity.this, null);
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    if (isManagePlayer/*btnEditPlayer.getText().toString().equals(getString(R.string.DoneEditing))*/) {
                        ...
                        if (!isAddplayerClicked) {
                            ...
                            Intent intent = new Intent(DWManagePlayerActivity.this, DWAddEditPlayerActivity.class);
                        ...
                        PlayerUtil.setSelectedPlayer(DWManagePlayerActivity.this, mPlayersAdapter.getItem(position));
                        if (listener != null) {
...
//                        } else {
//                            Intent intent = new Intent(DWManagePlayerActivity.this, DWPlaysetScanActivity.class);
//                            intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
//                        }
    ...
    private void intUI() {
        ...
        rlRootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (heightDiff > Util.dpToPx(DWManagePlayerActivity.this, Numerics.HUNDRED * Numerics.TWO)) {
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.btnBack) { // <<<<<<<<<<<<<<<<<<<< 这里会在安卓活动间跳转,可以转回到游戏里
            ...
            if (!getIntent().hasExtra(Constants.EXTRA_IS_FROM_GAME) && !isManagePlayer) {
                if (getString(R.string.game_activity) != null) {
                    try {
                        ...
                        Intent gameIntent = new Intent(DWManagePlayerActivity.this, className);
...
//                    finish();
                    ...
                    intent.putExtra(Constants.EXTRA_FROM_MENU, true); // 从安卓SDK 菜单中跳转的 ?
                    ...
                    public void onResponse(Call<List<PlayerDO>> call, Response<List<PlayerDO>> response) {
                        ...
                        try {
                            if (response.body() != null) {
                                ...
                                Util.savePlayersListToFile(DWManagePlayerActivity.this, new Gson().toJson(playersList));
                                ...
                                NetworkUtil.callReAuthenticationAPI(DWManagePlayerActivity.this, DWManagePlayerActivity.this, true);
                            }
    ...
    private void getStoredPlayersList() {
        ...
        String jsonString = Util.getPlayersListFromFile(DWManagePlayerActivity.this);
...
//                Intent intent = new Intent(DWManagePlayerActivity.this, DWAddNewPlayerActivity.class);
//                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
//                startActivityForResult(intent, Numerics.ZERO);
            ...
            PlayerUtil.setSelectedPlayer(DWManagePlayerActivity.this, mPlayersAdapter.getItem(Numerics.ZERO));
...
//            }
            ...
            Util.playSound(DWManagePlayerActivity.this, Constants.AUDIO_SELECT_PLAYER);
        }
    }
    ...
    private boolean isUserLoggedIn() {
        if (!sharedPrefUtil.getBoolean(SharedPrefUtil.PREF_LOGIN_USER_STATUS)) {
            Intent i = new Intent(DWManagePlayerActivity.this, DWLoginActivity.class);
